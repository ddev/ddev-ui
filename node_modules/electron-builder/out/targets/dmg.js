...
let customizeDmg = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (volumePath, specification, packager, backgroundFile, backgroundFilename) {
        ...
        const env = Object.assign({}, process.env, { volumePath, appFileName: `${packager.appInfo.productFilename}.app`, iconSize: specification.iconSize || 80, iconTextSize: specification.iconTextSize || 12, windowX: window.x, windowY: window.y, LC_ALL: "en_US.UTF-8", LANG: "en_US.UTF-8", VERSIONER_PERL_PREFER_32_BIT: "true" });
        if (specification.icon == null) {
...
class DmgTarget extends (_core || _load_core()).Target {
    ...
    build(appPath, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield (0, (_builderUtil || _load_builderUtil()).spawn)("hdiutil", ["resize", "-size", finalSize.toString(), tempDmg]);
