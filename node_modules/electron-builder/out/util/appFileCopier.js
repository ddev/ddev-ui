...
function getDestinationPath(file, fileSet) {
    return file === fileSet.src ? fileSet.destination : file.replace((0, (_AppFileCopierHelper || _load_AppFileCopierHelper()).ensureEndSlash)(fileSet.src), (0, (_AppFileCopierHelper || _load_AppFileCopierHelper()).ensureEndSlash)(fileSet.destination));
}