...
class ProjectNavItem extends React.PureComponent {
  render() {
    ...
    return (
      ...
      >
        <NavLink className="w-100 h-100" to={navLinkHref} data-sitename={this.props.name}>
          <div
            className="align-items-center d-flex flex-row h-100 w-100"
            data-sitename={this.props.name}
          >
            <ProjectStatusIcon className="project-status-icon ml-2" status={this.props.status} />
            <span className="pl-3">
